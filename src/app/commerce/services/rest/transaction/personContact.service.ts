...
export class PersonContactService extends TransactionService {
    ...
    getAllPersonContact(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (CommerceEnvironment.transactionUseMocks || useMocks) {
            method = 'GET';
            requestUrl = 'mocks/commerce/transaction' + path + '.getAllPersonContact.mocks.json';
        }
        let form = {};
        let body = {};
     ...
     * `@method`
     * `@name PersonContact#findPersonContactById`
     *
     * `@param {any} headers (optional)` will add headers to rest request
     *
     * `@param {string} url (optional)` will override the default domain used by the service. Url can be relative or absolute
    ...
    findPersonContactById(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        let domain = url || this.getRequestUrl();
        let path = '/store/{storeId}/person/@self/contact/byAddressId/{addressId}';
        let requestUrl = domain + path;
        let method = 'GET';
        if (CommerceEnvironment.transactionUseMocks || useMocks) {
            method = 'GET';
            requestUrl = 'mocks/commerce/transaction' + path + '.findPersonContactById.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
        ...
        if (parameters.pathParameters['storeId'] === undefined) {
            throw new Error("Request '/store/{storeId}/person/@self/contact/byAddressId/{addressId}' missing required parameter storeId");
        }

        //allow use of param with or without underscore
        parameters['addressId'] = parameters['addressId'] || parameters['addressId'];
        parameters.pathParameters['addressId'] = parameters.pathParameters['addressId'] || parameters.pathParameters['addressId'];
        if (parameters.pathParameters['addressId'] === undefined) {
            parameters.pathParameters['addressId'] = parameters['addressId'];
        }
        requestUrl = requestUrl.replace('{addressId}', parameters.pathParameters['addressId']);

        if (parameters.pathParameters['addressId'] === undefined) {
            throw new Error("Request '/store/{storeId}/person/@self/contact/byAddressId/{addressId}' missing required parameter addressId");
        }
     ...
     * `@method`
     * `@name PersonContact#findPersonContactByNickName`
     *
     * `@param {any} headers (optional)` will add headers to rest request
     *
     * `@param {string} url (optional)` will override the default domain used by the service. Url can be relative or absolute
    ...
    findPersonContactByNickName(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (CommerceEnvironment.transactionUseMocks || useMocks) {
            method = 'GET';
            requestUrl = 'mocks/commerce/transaction' + path + '.findPersonContactByNickName.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
        ...
        //allow use of param with or without underscore
        parameters['nickName'] = parameters['nickName'] || parameters['nickName'];
        parameters.pathParameters['nickName'] = parameters.pathParameters['nickName'] || parameters.pathParameters['nickName'];
        if (parameters.pathParameters['nickName'] === undefined) {
            parameters.pathParameters['nickName'] = parameters['nickName'];
        }
        requestUrl = requestUrl.replace('{nickName}', parameters.pathParameters['nickName']);
    ...
    addPersonContact(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (CommerceEnvironment.transactionUseMocks || useMocks) {
            method = 'GET';
            requestUrl = 'mocks/commerce/transaction' + path + '.addPersonContact.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
    ...
    updatePersonContact(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (CommerceEnvironment.transactionUseMocks || useMocks) {
            method = 'GET';
            requestUrl = 'mocks/commerce/transaction' + path + '.updatePersonContact.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
    ...
    deletePersonContact(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (CommerceEnvironment.transactionUseMocks || useMocks) {
            method = 'GET';
            requestUrl = 'mocks/commerce/transaction' + path + '.deletePersonContact.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
