...
export class GuestIdentityService extends TransactionService {
    ...
    login(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        let path = '/store/{storeId}/guestidentity';
        let requestUrl = domain + path;
        let method = 'POST';
        if (CommerceEnvironment.transactionUseMocks || useMocks) {
            method = 'GET';
            requestUrl = 'mocks/commerce/transaction' + path + '.login.mocks.json';
        }
        let form = {};
        let body = {};
        ...
        if (parameters.pathParameters['storeId'] === undefined) {
            throw new Error("Request '/store/{storeId}/guestidentity' missing required parameter storeId");
        }
    ...
    logout(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        let domain = url || this.getRequestUrl();
        let path = '/store/{storeId}/guestidentity/@self';
        let requestUrl = domain + path;
        let method = 'DELETE';
        if (CommerceEnvironment.transactionUseMocks || useMocks) {
            method = 'GET';
            requestUrl = 'mocks/commerce/transaction' + path + '.logout.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
        ...
        if (parameters.pathParameters['storeId'] === undefined) {
            throw new Error("Request '/store/{storeId}/guestidentity/@self' missing required parameter storeId");
        }
