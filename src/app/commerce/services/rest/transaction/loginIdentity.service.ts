...
export class LoginIdentityService extends TransactionService {
    ...
    login(parameters: any, headers ? : any, url ? : string): Observable < Response > {
        ...
        let path = '/store/{storeId}/loginidentity';
        ...
        if (parameters.pathParameters['storeId'] === undefined) {
            throw new Error("Request '/store/{storeId}/loginidentity' missing required parameter storeId");
        }
    ...
    logout(parameters: any, headers ? : any, url ? : string): Observable < Response > {
        ...
        let domain = url || this.getRequestUrl();
        let path = '/store/{storeId}/loginidentity/@self';
        let requestUrl = domain + path;
        let method = 'DELETE';
        if (CommerceEnvironment.transactionUseMocks || useMocks) {
            method = 'GET';
        ...
        if (parameters.pathParameters['storeId'] === undefined) {
            throw new Error("Request '/store/{storeId}/loginidentity/@self' missing required parameter storeId");
        }
